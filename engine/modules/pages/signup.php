...
$pagetitle = 'Регистрация'; // Название страницы
$description = 'описания';       // Описания страницы
$keywords = 'теги';              // Ключевые слова черз запятую

?>


<!--form class="sign" action="/index.php" method="post">
<input name="email" type="mail" placeholder="Email" size="25" maxlength="50" class="box"><br>
<input name="name" type="text" placeholder="Имя" size="25" maxlength="100" class="box"><br>
<input name="login" type="text" placeholder="Логин" size="25" maxlength="50" class="box"><br>
<input name="password" type="password" placeholder="Пароль" size="25" maxlength="100" class="box"><br>
...
<br><select size="1" name="country"><option value="0" disabled selected> Страна </option><option value="1">Украина</option><option value="2">Россия</option><option value="3">США</option><option value="4">Канада</option></select>
